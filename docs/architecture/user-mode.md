...
- **System V IPC** (`ipc`, `syscall::ipc`). The objects of every
  ...
  goes with its last attach even when its last process was killed.
...
- **System calls.** 252 calls across descriptors and I/O, paths and
