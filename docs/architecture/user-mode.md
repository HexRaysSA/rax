...
- **System V IPC** (`ipc`, `syscall::ipc`). The objects of every
  ...
  process, when the table is next read after it is gone.
...
- **System calls.** 256 calls across descriptors and I/O, paths and
