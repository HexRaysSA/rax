...
- **System calls.** 294 calls across descriptors and I/O, paths and
  ...
  descriptors, `epoll`, sockets, System V IPC, seccomp, inotify, and
  machine administration and mounts, each validated in the kernel's order so the first failing
